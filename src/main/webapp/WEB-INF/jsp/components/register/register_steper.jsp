<ol class="flex items-center  w-full mb-4 sm:mb-5">
    <li class="flex w-full items-center text-teal-600 dafter:content-[''] after:w-full after:h-1 after:border-b after:border-teal-200 after:border-4 after:inline-block ">
        <div class="flex items-center justify-center w-10 h-10 bg-teal-100 rounded-full lg:h-12 lg:w-12 shrink-0">
