    ...
    <div class="relative p-4 w-full max-w-3xl h-full md:h-auto">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow  sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 ">
                <h3 class="text-lg font-semibold">Agregar Medicina</h3>
                <button type="button"
            ...
            <form:form action="saveProduct?page=products" method="post" modelAttribute="product"
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        <label for="price" class="block mb-2 text-sm font-medium text-gray-900 ">Precio de la
                            medicina</label>
                    ...
                    <div>
                        ...
                        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 "
                               aria-describedby="file_input_help" id="file_input" type="file" name="file" required="true">
                    ...
                    <div>
                        <label for="stock" class="block mb-2 text-sm font-medium text-gray-900 ">Stock de la
                            medicina</label>
                        <form:input type="number" path="stock" id="stock"
                    ...
                    <div class="sm:col-span-2">
                        <label for="description" class="block mb-2 text-sm font-medium text-gray-900">Escribe la
                            descripción de la medicina</label>
