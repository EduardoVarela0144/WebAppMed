            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="p-4">Especialidad</th>
                        <th scope="col" class="p-4">Consulta</th>
                    ...
                    <c:forEach var="doctor" items="${listUsers}">
                        <c:if test="${not empty doctor.id_doctor}">
                            ...
                            <tr class="border-b  hover:bg-gray-100">
                                ...
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                    <div class="flex items-center mr-3">
                                        Dr. ${doctor.name} ${doctor.ape_pat} ${doctor.ape_mat}
                                    </div>
                                </th>

                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                    <div class="flex items-center mr-3">
                                            ${doctor.id_doctor.clinic_address}
                                    </div>
                                </th>

                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                    <div class="flex items-center mr-3">
                                            ${doctor.id_doctor.clinic_number}
                                    </div>
                                </th>

                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                    <div class="flex items-center mr-3">
                                            ${doctor.id_doctor.specialties.name}
                                    </div>
                                </th>

                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                    <div class="flex items-center mr-3">
                                            ${doctor.id_doctor.cost}
                                    </div>
                                </th>
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                    <div class="flex items-center space-x-4">
                                        <button id=${doctor.id_doctor.id_doctor} onclick="edit_element(this.id)" type="button" data-drawer-target="drawer-update-product"
                                        ...
                                        <button id=${doctor.id_doctor.id_doctor} onclick="delete_element(this.id)"  type="button" data-modal-target="delete-modal"
    ...
    function edit_element(idButton) {
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log(data);
                document.getElementById("clinic_address_edit").value = data.clinic_address;
                document.getElementById("clinic_number_edit").value = data.clinic_number;
                document.getElementById("cost_edit").value = data.cost;
                document.getElementById("id_doctor").value = data.id_doctor;
                document.getElementById("specialties_edit").value = data.specialties.id_speciality;
            },
            error: function () {
