                        ...
                        <tr class="border-b  hover:bg-gray-100">
                            ...
                            <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                <div class="flex items-center space-x-4">
                                    <button id=${doctor.id_doctor} onclick="edit_element(this.id)" type="button" data-drawer-target="drawer-update-product"
                                    ...
                                    <button id=${doctor.id_doctor} onclick="delete_element(this.id)"  type="button" data-modal-target="delete-modal"
