...
<form:form action="editSavePatient" method="post" modelAttribute="patient" id="drawer-update-product"
    ...
    <h5 id="drawer-label"
        class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase">Actualizar paciente</h5>
    ...
    <div class="grid gap-4 mb-4 sm:grid-cols-1">
        <form:hidden path="id_patient" id="id_patient" class="form-control input-sm" />

        <div>
            <label for="address" class="block mb-2 text-sm font-medium text-gray-900 ">Dirección</label>
            <form:input
                    path="address" type="text" name="address" id="address_edit"
        ...
        <div>
            ...
            <form:input
                    path="phone_number" type="text" name="phone_number" id="phone_number_edit"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-black focus:border-black block w-full p-2.5"
