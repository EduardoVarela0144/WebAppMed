                    ...
                    <c:forEach var="patient" items="${listUsers}">
                        <c:if test="${not empty patient.id_patient}">
                            ...
                            <tr class="border-b  hover:bg-gray-100">
                                ...
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                    <div class="flex items-center mr-3">
                                         ${patient.name} ${patient.ape_pat} ${patient.ape_mat}
                                    </div>
                                </th>

                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                    <div class="flex items-center mr-3">
                                            ${patient.id_patient.address}
                                    </div>
                                </th>

                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                    <div class="flex items-center mr-3">
                                            ${patient.id_patient.phone_number}
                                    </div>
                                </th>

                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                    <div class="flex items-center space-x-4">
                                        <button id=${patient.id_patient.id_patient} onclick="edit_element(this.id)" type="button"
                                        ...
                                        <button id=${patient.id_patient.id_patient} onclick="delete_element(this.id)" type="button"
    ...
    function edit_element(idButton) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                document.getElementById("phone_number_edit").value = data.phone_number;
                document.getElementById("id_patient").value = data.id_patient;
            },
            error: function () {
