            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="p-4">Horario</th>
                    ...
                    <c:forEach var="appointment" items="${listAppointments}">
                        <tr class="border-b  hover:bg-gray-100">
                            ...
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                <div class="flex items-center mr-3">
                                      Dr  ${appointment.id_doctor.name}  ${appointment.id_doctor.ape_pat}  ${appointment.id_doctor.ape_mat}
                                </div>
                            </th>

                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                <div class="flex items-center mr-3">
                                        ${appointment.id_patient.name} ${appointment.id_patient.ape_pat}  ${appointment.id_patient.ape_mat}
                                </div>
                            </th>
                            ...
                            <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                <div class="flex items-center space-x-4">
                                    <button id=${appointment.id_appointments} onclick="edit_element(this.id)" type="button" data-drawer-target="drawer-update-product"
                                    ...
                                    <button id=${appointment.id_appointments} onclick="delete_element(this.id)"  type="button" data-modal-target="delete-modal"
...
<script>
    function delete_element(idButton) {
        ...
        button.href = "deleteAppointment/" + idButton;
    }
    ...
    function edit_element(idButton) {
        ...
        var url = "api/appointments/" + idButton;
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log(data);
                document.getElementById("edit_id_appointments").value = data.id_appointments;
                document.getElementById("edit_id_doctor").value = data.id_doctor.id_user;
                document.getElementById("edit_id_patient").value = data.id_patient.id_user;
                document.getElementById("edit_appointment_date").value = data.appointment_date;
                document.getElementById("hourStart_edit").value = data.hourStart;
                document.getElementById("hourEnd_edit").value = data.hourEnd;
            },
            error: function () {
