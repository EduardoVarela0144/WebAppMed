    ...
    <div class="relative p-4 w-full max-w-3xl h-full md:h-auto">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow  sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 ">
                <h3 class="text-lg font-semibold">Agregar cita</h3>
                <button type="button"
            ...
            <form:form action="/saveAppointment?page=appointments" method="post" modelAttribute="appointment">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">


                    <div class="sm:col-span-2">
                        <label for="appointment_date" class="block mb-2 text-sm font-medium text-gray-900 ">Fecha de la
                            cita</label>
                        <div class="relative">
                            ...
                            <input datepicker name="appointment_date" path="appointment_date" id="appointment_date"
                                   type="text"
