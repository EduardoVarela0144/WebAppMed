...
<form:form action="/saveSpeciality?page=specialities" method="post" modelAttribute="speciality" id="drawer-update-product"
    ...
    <h5 id="drawer-label"
        class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase">Actualizar especialidad</h5>
    ...
    <div class="grid gap-4 mb-4 sm:grid-cols-1">
        <form:hidden path="id_speciality" id="id_speciality" class="form-control input-sm" />
        ...
        <div class="sm:col-span-2">
            <label for="description" class="block mb-2 text-sm font-medium text-gray-900">Escribe la descripción de la
                especialidad</label>
            <form:textarea type="text" path="description"
                           id="description_edit" rows="4"
