                        ...
                        <tr class="border-b  hover:bg-gray-100">
                            ...
                            <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                <div class="flex items-center space-x-4">
                                    <button  id=${speciality.id_speciality} onclick="edit_element(this.id)" type="button" data-drawer-target="drawer-update-product"
                                    ...
                                    <button id=${speciality.id_speciality} onclick="delete_element(this.id)"
    ...
    function edit_element(idButton) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                document.getElementById("id_speciality").value = data.id_speciality;
            },
            error: function() {
