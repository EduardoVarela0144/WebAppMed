            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="p-4">Nombre del doctor</th>
                        <th scope="col" class="p-4">Id del doctor</th>
                    ...
                    <c:forEach var="schedule" items="${listSchedules}">
                        ...
                        <tr class="border-b  hover:bg-gray-100">
                            ...
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                <div class="flex items-center mr-3">
                                       Dr. ${schedule.id_doctor.name}  ${schedule.id_doctor.ape_pat} ${schedule.id_doctor.ape_mat}
                                </div>
                            </th>

                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                <div class="flex items-center mr-3">
                                        ${schedule.id_doctor.id_doctor.id_doctor}
                                </div>
                            </th>

                            <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                <div class="flex items-center space-x-4">
                                    <button id=${schedule.id_schedules} onclick="edit_element(this.id)" type="button"
                                    ...
                                    <button id=${schedule.id_schedules} onclick="delete_element(this.id)" type="button"
...
<script>
    function delete_element(idButton) {
        ...
        button.href = "/deleteSchedule/" + idButton;
    }
    ...
    function edit_element(idButton) {
        ...
        var url = "/api/schedules/" + idButton;
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log(data)
                document.getElementById("id_schedules").value = data.id_schedules;

                document.getElementById("hourStart_edit").value = data.hourStart;
                document.getElementById("hourEnd_edit").value = data.hourEnd;
                document.getElementById("id_doctor_edit").value = data.id_doctor.id_user;
                document.getElementById("date_schedule_edit").value = data.date_schedule;
