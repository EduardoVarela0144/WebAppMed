...
<form:form action="/saveSchedule?page=schedules" method="post" modelAttribute="schedule" id="drawer-update-product"
    ...
    <h5 id="drawer-label"
        class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase">Actualizar horario</h5>
    ...
    <div class="grid gap-4 mb-4 sm:grid-cols-1">
        <form:hidden path="id_schedules" id="id_schedules" class="form-control input-sm"/>


        <div class="sm:col-span-2">
            <label for="date_schedule_edit" class="block mb-2 text-sm font-medium text-gray-900 ">Fecha del horario de
                atención</label>
            <div class="relative">
                ...
                <input datepicker name="date_schedule" path="date_schedule" id="date_schedule_edit"
                       type="text"
