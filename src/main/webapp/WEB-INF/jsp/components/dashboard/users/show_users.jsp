            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="p-4">Apellido paterno</th>
                        <th scope="col" class="p-4">Apellido materno</th>
                    ...
                    <c:forEach var="user" items="${listUsers}">
                        ...
                        <tr class="border-b  hover:bg-gray-100">
                            ...
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">
                                <div class="flex items-center mr-3 text-truncate">
                                        ${user.ape_pat}
                                </div>
                            </th>
                            ...
                            <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                <div class="flex items-center space-x-4">
                                    <button  id=${user.id_user} onclick="edit_element(this.id)" type="button" data-drawer-target="drawer-update-product"
                                    ...
                                    <button id=${user.id_user} onclick="delete_element(this.id)"
    ...
    function edit_element(idButton) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                document.getElementById("ape_pat_edit").value = data.ape_pat;
                document.getElementById("ape_mat_edit").value = data.ape_mat;
                ...
                document.getElementById("id_doctor_edit").value = data.id_doctor ? data.id_doctor.id_doctor : 0;
                document.getElementById("id_patient_edit").value = data.id_patient.id_patient ? data.id_patient.id_patient : 0 ;
